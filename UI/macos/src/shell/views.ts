...
export const VIEW_META: Record<ViewId, ViewMeta> = {
  pullRequests: { id: 'pullRequests', navLabel: 'Pull Request', title: 'Pull Request', get subtitle() { return t("查看与你相关的代码审查"); }, icon: 'pull-request', group: 'work', fullWidth: false },
  chat: {
    id: 'chat',
    get navLabel() { return t("对话"); },
    get title() { return t("对话"); },
    get subtitle() { return t("和当前渠道直接说上话，验证配置是不是真的能用"); },
    icon: 'chat',
    group: 'session',
  ...
  channels: {
    id: 'channels',
    get navLabel() { return t("渠道"); },
    get title() { return t("渠道"); },
    get subtitle() { return t("选择渠道与模型，开始会话"); },
    icon: 'channels',
    group: 'session',
    fullWidth: true,
  },
  slots: {
    id: 'slots',
    get navLabel() { return t("槽位"); },
    get title() { return t("模型槽位"); },
    get subtitle() { return t("四个槽位分别绑到哪个渠道的哪个模型"); },
    icon: 'slots',
    group: 'session',
    fullWidth: false,
  },
  usage: {
    id: 'usage',
    get navLabel() { return t("用量"); },
    get title() { return t("用量与成本"); },
    get subtitle() { return t("token 花在哪儿、缓存命中多少"); },
    icon: 'usage',
    group: 'observe',
    fullWidth: false,
  },
  diagnostics: {
    id: 'diagnostics',
    get navLabel() { return t("诊断"); },
    get title() { return t("诊断"); },
    get subtitle() { return t("失败了什么、悄悄降级了什么"); },
    icon: 'diagnostics',
    group: 'observe',
    fullWidth: true,
  },
  accounts: {
    id: 'accounts',
    get navLabel() { return t("账号池"); },
    get title() { return t("账号池"); },
    get subtitle() { return t("同一渠道的多个账号怎么轮换"); },
    icon: 'accounts',
    group: 'observe',
    fullWidth: true,
  },
  doctor: {
    id: 'doctor',
    get navLabel() { return t("体检"); },
    get title() { return t("本机体检"); },
    get subtitle() { return t("本机配置有没有问题，只读不联网"); },
    icon: 'doctor',
    group: 'observe',
    fullWidth: false,
  },
  plugins: {
    id: 'plugins',
    get navLabel() { return t("插件"); },
    get title() { return t("插件"); },
    get subtitle() { return t("hooks、输出风格、状态栏、权限这些扩展点各自是什么状态"); },
    icon: 'plugins',
    group: 'extend',
    fullWidth: false,
  },
  tasks: {
    id: 'tasks',
    get navLabel() { return t("定时任务"); },
    get title() { return t("定时任务"); },
    get subtitle() { return t("应用运行期间自动触发，退出或休眠后不补跑"); },
    icon: 'tasks',
    group: 'work',
    fullWidth: false,
  },
  settings: {
    id: 'settings',
    get navLabel() { return t("设置"); },
    get title() { return t("设置"); },
    get subtitle() { return t("外观、路径与本机环境"); },
    icon: 'settings',
    group: 'system',
    fullWidth: false,
  },
...
export const GROUP_LABEL: Record<ViewGroup, string> = {
  get work() { return t("工作"); },
  get session() { return t("会话"); },
  get observe() { return t("观测"); },
  get extend() { return t("扩展"); },
