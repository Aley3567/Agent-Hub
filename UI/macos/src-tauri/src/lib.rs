...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            provider_management::apply_import,
            provider_management::cancel_import,
            provider_management::provider_edit_view,
            provider_management::save_provider,
            provider_management::remove_provider,
            provider_management::credential_status,
