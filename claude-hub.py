...
# Upstream HTTP rejections that may exhaust a route target. Local pool
# exhaustion and native pre-delivery replay exhaustion are handled separately.
...
# ------------------------------------- request errors and provider resolution
